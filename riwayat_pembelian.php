...
$sql_pembelian = "SELECT id, nama_barang, tanggal_pembelian, jumlah FROM pembelian";
...
<head>
    ...
    <title>Riwayat Pembelian - SportsCenter</title>
    <!-- Bootstrap CSS -->
...
<div class="sidebar">
    ...
    <div class="menu">
        ...
        <a href="riwayat_pembelian.php" class="active"><i class="fas fa-history"></i> Riwayat Pembelian</a> 
...
<div class="content">
    ...
    <div class="container mt-5">
        <table class="table table-bordered mt-3">
            ...
            <?php while($data = $result_pembelian->fetch_assoc()) { ?>
            <tr>
